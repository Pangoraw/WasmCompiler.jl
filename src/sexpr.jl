...
takes(_, _, ::Union{i32_store,i64_store,f32_store,f64_store}) = 2
takes(_, _, ::Union{i32_load,i64_load,f32_load,f64_load}) = 1
...
produces(_, _, ::Union{i32_load,i64_load,f32_load,f64_load}) = 1
